    ...
    <div className="container mx-auto text-center mb-10 relative">
        ...
        <div className="absolute right-0 bottom-[-30px] flex space-x-2">
            ...
            disabled={!canScrollLeft}
             className={`p-2 rounded border ${canScrollLeft ? " bg-white text-black": "bg-gray-200 text-gray-200 cursor-not-allowed"}`}>
            <FaArrowAltCircleLeft className='text-2xl' />
            </button>
            <button 
            onClick={()=> scroll("right")}
            disabled={!canScrollRight}
            className={`p-2 rounded border ${canScrollRight ? " bg-white text-black": "bg-gray-200 text-gray-200 cursor-not-allowed"}`}>
